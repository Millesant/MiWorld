...
public class DefaultSelection implements Selection {
    ...
    public void rotate(int angle) {
        ...
        this.setFirstPoint(rotateVector(new Vector3(firstPointX, this.getFirstPoint().getY(), firstPointZ), angle, centerX, centerZ));
        this.setSecondPoint(rotateVector(new Vector3(secondPointX, this.getSecondPoint().getY(), secondPointZ), angle, centerX, centerZ));
    }

    private Vector3 rotateVector(Vector3 vector, int angle, double centerX, double centerZ) {
        return switch (angle) {
