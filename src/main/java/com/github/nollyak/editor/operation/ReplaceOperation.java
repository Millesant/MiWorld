            ...
            for (
                ...
                for (
                    ...
                    for (
                        ...
                        if (
                            currentBlock.getId() == this.fromBlock().getId()
                                && currentBlock.getDamage() == this.fromBlock().getDamage()
                        ) {
                            historyChanges.add(new DefaultHistoryChange(position, currentBlock, this.toBlock()));
